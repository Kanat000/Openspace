            ...
            <div className={aSideStyle.aSide}>
                ...
                <div className={aSideStyle.Body}>
                    <div className={aSideStyle.filterContainer}>
                        <div className={aSideStyle.filterBlock}>
                            ...
                            <div className={aSideStyle.filterInputBlock}>
                                ...
                                <input type="text" id="bySubject" className={aSideStyle.filterInput} placeholder="Search" />
                        ...
                        <div className={aSideStyle.filterBlock}>
                            <div className={aSideStyle.filterLabelBlock}>
                                <label htmlFor="bySpecialism">By Specialism:</label>
                            </div>
                            <div className={aSideStyle.filterInputBlock}>
                                <input type="text" id="bySpecialism" className={aSideStyle.filterInput} placeholder="Search" />
                                    <button className={aSideStyle.addButton}>
                                        <svg xmlns="http://www.w3.org/2000/svg" className={aSideStyle.AddIcon} viewBox="0 0 16 16">
                                            <path
                                                d="M8 0a1 1 0 0 1 1 1v6h6a1 1 0 1 1 0 2H9v6a1 1 0 1 1-2 0V9H1a1 1 0 0 1 0-2h6V1a1 1 0 0 1 1-1z"/>
                        ...
                        <div className={aSideStyle.filterBlock}>
                            <div className={aSideStyle.filterLabelBlock}>
                                <label htmlFor="byUniversity">By University:</label>
                            </div>
                            <div className={aSideStyle.filterInputBlock}>
                                <input type="text" id="byUniversity" className={aSideStyle.filterInput} placeholder="Search" />
                                    <button className={aSideStyle.addButton}>
                                        <svg xmlns="http://www.w3.org/2000/svg" className={aSideStyle.AddIcon} viewBox="0 0 16 16">
                                            <path
                                                d="M8 0a1 1 0 0 1 1 1v6h6a1 1 0 1 1 0 2H9v6a1 1 0 1 1-2 0V9H1a1 1 0 0 1 0-2h6V1a1 1 0 0 1 1-1z"/>
                   ...
                   <div className={aSideStyle.UseFilter}>
                       <button className={aSideStyle.UseBtn}>Use Filter</button>
                   </div>
